  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case SkladRow:
            return SkladRow(data);
          case SpisanieRow:
            return SpisanieRow(data);
          case ResultinfoRow:
            return ResultinfoRow(data);
          case PricesRow:
            return PricesRow(data);
          case AdmandEvaRow:
            return AdmandEvaRow(data);
          case SpisanieNewRow:
            return SpisanieNewRow(data);
          case TestRow:
            return TestRow(data);
          case Sheet1Row:
            return Sheet1Row(data);
          case NomenclatureRow:
            return NomenclatureRow(data);
          case NcEvolutionsRow:
            return NcEvolutionsRow(data);
          default:
            return null;
        }
